...
class final_chat_maintenance extends StatefulWidget {
  var uid_seller,Name_of_seller,imageurl_of_seller;

  final_chat_maintenance({ this.uid_seller, this.Name_of_seller, this.imageurl_of_seller,});


  @override
  State<final_chat_maintenance> createState() => _final_chat_maintenanceState();
}

class _final_chat_maintenanceState extends State<final_chat_maintenance> {
          ...
          children: [
            Expanded(
              child: StreamBuilder<QuerySnapshot>(
                  ...
                  where("Name_of_product",isEqualTo:"maintenance").
                  where("Price_of_product",isEqualTo:"").
                  snapshots(),
